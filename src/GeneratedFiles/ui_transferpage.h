...
public:
    ...
    void setupUi(QWidget *TransferPage)
    {
        ...
        unitLabel->setGeometry(QRect(330, 220, 51, 16));
        ...
        unitLabel2->setGeometry(QRect(330, 275, 51, 16));
    ...
    void retranslateUi(QWidget *TransferPage)
    {
        ...
        balanceLabel->setText(QApplication::translate("TransferPage", "<html><head/><body><p><span style=\" font-size:26px;\">0.00</span><span style=\" font-size:12px;\"> ALC</span></p></body></html>", Q_NULLPTR));
        ...
        unitLabel->setText(QApplication::translate("TransferPage", "ALC", Q_NULLPTR));
        feeLabel->setText(QApplication::translate("TransferPage", "Fee", Q_NULLPTR));
        feeLineEdit->setText(QString());
        unitLabel2->setText(QApplication::translate("TransferPage", "ALC", Q_NULLPTR));
