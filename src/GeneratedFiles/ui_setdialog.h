...
"background:transparent;"));
    ...
    void retranslateUi(QDialog *SetDialog)
    {
        ...
        languageComboBox->insertItems(0, QStringList()
         ...
         << QApplication::translate("SetDialog", "\355\225\234\352\265\255\354\226\264.", Q_NULLPTR)
        ...
        linkBtn->setText(QApplication::translate("SetDialog", "www.ALabsChain.com", Q_NULLPTR));
