...
QT_MOC_LITERAL(3, 35, 32), // "on_consoleLineEdit_returnPressed"
QT_MOC_LITERAL(4, 68, 21), // "executeConsoleCommand"
QT_MOC_LITERAL(5, 90, 6) // "result"

    },
    "ConsoleDialog\0on_closeBtn_clicked\0\0"
    "on_consoleLineEdit_returnPressed\0"
    "executeConsoleCommand\0result"
};
...
void ConsoleDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ConsoleDialog *_t = static_cast<ConsoleDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_closeBtn_clicked(); break;
        case 1: _t->on_consoleLineEdit_returnPressed(); break;
        case 2: _t->executeConsoleCommand((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject ConsoleDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ConsoleDialog.data,
      qt_meta_data_ConsoleDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ConsoleDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConsoleDialog.stringdata0))
        return static_cast<void*>(const_cast< ConsoleDialog*>(this));
