...
void MyProgressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyProgressBar::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyProgressBar::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyProgressBar::valueChanged(int _t1)
{
