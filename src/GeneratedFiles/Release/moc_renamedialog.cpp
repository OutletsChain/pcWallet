...
QT_MOC_LITERAL(4, 52, 27), // "on_nameLineEdit_textChanged"
QT_MOC_LITERAL(5, 80, 4), // "arg1"
QT_MOC_LITERAL(6, 85, 29), // "on_nameLineEdit_returnPressed"
QT_MOC_LITERAL(7, 115, 15), // "jsonDataUpdated"
QT_MOC_LITERAL(8, 131, 2) // "id"

    },
    "RenameDialog\0on_okBtn_clicked\0\0"
    "on_cancelBtn_clicked\0on_nameLineEdit_textChanged\0"
    "arg1\0on_nameLineEdit_returnPressed\0"
    "jsonDataUpdated\0id"
};
...
void RenameDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_nameLineEdit_textChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->on_nameLineEdit_returnPressed(); break;
        case 4: _t->jsonDataUpdated((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
