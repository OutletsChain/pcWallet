...
QT_MOC_LITERAL(1, 11, 8), // "onShowUp"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8) // "doShowUp"

    },
    "MyComboBox\0onShowUp\0\0doShowUp"
};
...
void MyComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onShowUp(); break;
        case 1: _t->doShowUp(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyComboBox::onShowUp)) {
                *result = 0;
                return;
            }
        }
