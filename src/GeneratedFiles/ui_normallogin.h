...
public:
    ...
    void setupUi(QWidget *NormalLogin)
    {
        ...
        enterBtn->setGeometry(QRect(610, 370, 18, 7));
    ...
    void retranslateUi(QWidget *NormalLogin)
    {
        ...
        loginLabel->setText(QApplication::translate("NormalLogin", "<html><head/><body><p><span style=\" color:#00007f;\">Password:</span></p></body></html>", Q_NULLPTR));
        ...
        versionLabel_2->setText(QApplication::translate("NormalLogin", "OutletsChain Wallet", Q_NULLPTR));
