...
public:
    ...
    void setupUi(QWidget *SelectGopPathWidget)
    {
        ...
        pathLineEdit->setGeometry(QRect(368, 358, 227, 29));
        QFont font1;
        ...
        label->setGeometry(QRect(368, 338, 111, 20));
        label->setFont(font);
        label->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        okBtn = new QPushButton(SelectGopPathWidget);
        okBtn->setObjectName(QStringLiteral("okBtn"));
        okBtn->setGeometry(QRect(368, 420, 227, 24));
        okBtn->setFont(font);
...
"QPushButton::hover{color: rgb(153, 153, 153);}"));
        ...
        versionLabel_2->setGeometry(QRect(12, 10, 121, 16));
        QFont font2;
        ...
        versionLabel->setGeometry(QRect(130, 12, 81, 14));
        QFont font3;
        ...
        pathLineEdit_2 = new QLineEdit(SelectGopPathWidget);
        pathLineEdit_2->setObjectName(QStringLiteral("pathLineEdit_2"));
        pathLineEdit_2->setGeometry(QRect(368, 300, 227, 29));
        pathLineEdit_2->setFont(font1);
        pathLineEdit_2->setReadOnly(false);
        label_2 = new QLabel(SelectGopPathWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(368, 280, 191, 20));
        label_2->setFont(font);
        label_2->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        selectPathBtn = new QPushButton(SelectGopPathWidget);
        selectPathBtn->setObjectName(QStringLiteral("selectPathBtn"));
        selectPathBtn->setGeometry(QRect(605, 360, 80, 25));
...
"QPushButton::hover{color: rgb(153, 153, 153);}"));
    ...
    void retranslateUi(QWidget *SelectGopPathWidget)
    {
        ...
        label->setText(QApplication::translate("SelectGopPathWidget", "<html><head/><body><p><span style=\" color:#00007f;\">Local data path:</span></p></body></html>", Q_NULLPTR));
        okBtn->setText(QApplication::translate("SelectGopPathWidget", "Next", Q_NULLPTR));
        closeBtn->setText(QString());
        minBtn->setText(QString());
        textLabel->setText(QString());
        versionLabel_2->setText(QApplication::translate("SelectGopPathWidget", "OutletsChain Wallet", Q_NULLPTR));
        versionLabel->setText(QApplication::translate("SelectGopPathWidget", "Ver.1.0.0", Q_NULLPTR));
        logoLabel->setText(QString());
        label_2->setText(QApplication::translate("SelectGopPathWidget", "<html><head/><body><p><span style=\" color:#00007f;\">The url of initialize file:</span></p></body></html>", Q_NULLPTR));
