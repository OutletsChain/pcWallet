...
"background-color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QWidget *MainPage)
    {
        ...
        ___qtablewidgetitem2->setText(QApplication::translate("MainPage", "Balance/ALC", Q_NULLPTR));
        loadingLabel->setText(QApplication::translate("MainPage", "Loading data, please wait...", Q_NULLPTR));
        initLabel->setText(QApplication::translate("MainPage", "Please add your first ALabsChain account.", Q_NULLPTR));
    } // retranslateUi
