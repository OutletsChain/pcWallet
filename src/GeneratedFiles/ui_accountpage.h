...
"background:transparent;"));
        ...
        label_3->setStyleSheet(QStringLiteral("background-color: rgb(255, 160, 122);"));
    ...
    void retranslateUi(QWidget *AccountPage)
    {
        ...
        label_6->setText(QApplication::translate("AccountPage", "Invalid", Q_NULLPTR));
        ...
        label_13->setText(QApplication::translate("AccountPage", "Fee/ALC", Q_NULLPTR));
