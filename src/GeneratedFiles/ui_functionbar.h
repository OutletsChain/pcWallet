...
public:
    ...
    void setupUi(QWidget *FunctionBar)
    {
        ...
        contactBtn->setGeometry(QRect(20, 430, 92, 63));
        ...
        versionLabel_2->setGeometry(QRect(40, 510, 91, 26));
        QFont font2;
        ...
        logoLabel->setGeometry(QRect(7, 510, 25, 25));
    ...
    void retranslateUi(QWidget *FunctionBar)
    {
        ...
        versionLabel_2->setText(QApplication::translate("FunctionBar", "ALC Wallet\n"
"Ver.1.0.0", Q_NULLPTR));
        logoLabel->setText(QString());
        assertComboBox->clear();
        assertComboBox->insertItems(0, QStringList()
         << QApplication::translate("FunctionBar", "ALC", Q_NULLPTR)
        );
        assertComboBox->setCurrentText(QApplication::translate("FunctionBar", "ALC", Q_NULLPTR));
    } // retranslateUi
