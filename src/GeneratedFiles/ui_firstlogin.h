...
public:
    ...
    void setupUi(QWidget *FirstLogin)
    {
        ...
        FirstLogin->setStyleSheet(QStringLiteral("color:rgb(0, 0, 0)"));
        ...
        pwdLineEdit->setPalette(palette);
        QFont font;
        font.setFamily(QString::fromUtf8("\345\276\256\350\275\257\351\233\205\351\273\221"));
        pwdLineEdit->setFont(font);
        pwdLineEdit->setContextMenuPolicy(Qt::DefaultContextMenu);
        pwdLineEdit->setAutoFillBackground(false);
        pwdLineEdit->setStyleSheet(QLatin1String("color rgb(0, 0, 0)\n"
"color rgb(0, 0, 0)"));
        ...
        pwdLabel->setStyleSheet(QLatin1String("\n"
...
""));
        ...
        pwdLabel2_2->setGeometry(QRect(370, 380, 480, 51));
    ...
    void retranslateUi(QWidget *FirstLogin)
    {
        ...
        pwdLabel->setText(QApplication::translate("FirstLogin", "<html><head/><body><p><span style=\" color:#00007f;\">Set your login password:</span></p></body></html>", Q_NULLPTR));
        pwdLabel2->setText(QApplication::translate("FirstLogin", "<html><head/><body><p><span style=\" color:#00007f;\">Verify password:</span></p></body></html>", Q_NULLPTR));
        ...
        versionLabel_2->setText(QApplication::translate("FirstLogin", "ALabsChain Wallet", Q_NULLPTR));
        ...
        pwdLabel2_2->setText(QApplication::translate("FirstLogin", "<html><head/><body><p><span style=\" color:#00007f;\">Please keep your private key properly</span></p></body></html>", Q_NULLPTR));
    } // retranslateUi
