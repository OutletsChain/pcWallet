    ...
    QWidget(parent)
{
    ...
    signLabel->setPixmap( QPixmap(DataMgr::getDataMgr()->getWorkPath() + "pic2/progressSign.png"));
    signLabel->show();

    progressBar->setStyleSheet("QProgressBar{background-color: rgb(229,229,229);border-radius: 3px; border:0px solid rgb(0,0,0);}"
                  "QProgressBar::chunk:horizontal {background-color: rgb(244, 159, 23);margin: 0px 0px 0px 0px;border-radius: 3px;}"
                  );
}
